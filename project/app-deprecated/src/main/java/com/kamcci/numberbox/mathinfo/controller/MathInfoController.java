package com.kamcci.numberbox.mathinfo.controller;

import com.kamcci.numberbox.common.service.ImgFileService;
import com.kamcci.numberbox.mathinfo.dto.*;
import com.kamcci.numberbox.mathinfo.entity.MathResourceMenu;
import com.kamcci.numberbox.mathinfo.service.MathContentsInfoService;
import com.kamcci.numberbox.mathinfo.service.MathResourceService;
...
public class MathInfoController {
    ...
    public HashMap<String, Object> contentsInfo(HttpServletRequest request) {
        ...
        String onlyExistUnit = request.getParameter("onlyExistUnit");
    ...
    public HashMap<String, Object> typeInfoList(HttpServletRequest request) {
        String unitUniqNoList = request.getParameter("unitUniqNoList");
        HashMap<String, Object> map = new HashMap<String, Object>();
    ...
    public HashMap<String, Object> takeMyResource(HttpServletRequest request) throws IOException {
    ...
    public HashMap<String, Object> takePPtSlideImge(HttpServletRequest request) throws IOException {
        int resourceNo = Integer.parseInt(request.getParameter("resourceNo"));
