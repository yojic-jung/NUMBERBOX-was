package com.kamcci.numberbox.common.util;
...
public class MathProblemAnalyzer {
	...
	public String questionToChatGtp(String question, double temperature, int max_tokens, double top_p,
		...
		try {
			...
			Request request = new Request.Builder()
					.url("https://api.openai.com/v1/engines/text-davinci-002/completions").method("POST", body)
					.addHeader("Content-Type", "application/json").addHeader("Authorization", "Bearer " + apiKey)
					.build();
			Response response;
			...
			try {
				commonUtil.sendMail("dywlr74@naver.com", "[N명의 수학] openAi 사용량 초과 오류 발생",
						"[N명의 수학] openAi 사용량 초과 오류 발생");
