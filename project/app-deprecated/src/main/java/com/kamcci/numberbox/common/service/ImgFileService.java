package com.kamcci.numberbox.common.service;

import com.kamcci.numberbox.common.dto.ImgFileInfoDto;
import com.kamcci.numberbox.common.dto.ImgFileModel;
import com.kamcci.numberbox.common.dto.TmpImgFileInfoDto;
import com.kamcci.numberbox.common.entity.ImgFileInfo;
import com.kamcci.numberbox.common.repository.ImgFileInfoRepo;
import com.kamcci.numberbox.common.repository.TmpImgFileInfoRepo;
    ...
    public void registerImgFileInfo(int actionId, int contentsNo, List<String> imgTagList) {
        if (imgTagList != null && imgTagList.size() != 0) {
            ...
            for (String imgTag : imgTagList) {
                ...
                try {
                    // imgPathCode, imgPath, imgFileName 모두 기존 url에서 뽑아오기(url에서 뽑지 않고 연월 구해서 재셋팅하면
                    // 실제 저장된 s3 연월 폴더와 db에 저장된 폴더 경로 및 imgPathCode가 불일치 될 수 있음)
