package com.kamcci.numberbox.members.appservice.service;
...
import com.kamcci.numberbox.members.dto.MembersPrivateDto;
import com.kamcci.numberbox.members.dto.MembersProfileDto;
import com.kamcci.numberbox.members.dto.MembersRoleDto;
...
public class MembersRegisterService implements MembersRegisterUseCase {
    ...
    public MembersRegisterService(MembersRepository membersRepository, MembersRoleRepository membersRoleRepository, MembersPrivateRepository membersPrivateRepository, MembersProfileRepository membersProfileRepository, EmailIdCodeRepository emailIdCodeRepository, AuthPasswordEncoder authPasswordEncoder) {
