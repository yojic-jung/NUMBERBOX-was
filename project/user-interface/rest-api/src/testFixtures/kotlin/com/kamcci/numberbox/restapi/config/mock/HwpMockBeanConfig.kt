...
import com.kamcci.numberbox.app.service.mock.port.hwp.MockHwpConvertEventAdapter
...
import com.kamcci.numberbox.app.service.mock.usecase.hwp.MockHwpConvertFileWriteCase
...
class HwpMockBeanConfig {
    ...
    @Bean
    fun hwpConvertFileWriteCase(): HwpConvertFileWriteCase = MockHwpConvertFileWriteCase()

    @Bean
    fun hwpConvertEventPort(): HwpConvertEventPort = MockHwpConvertEventAdapter()
