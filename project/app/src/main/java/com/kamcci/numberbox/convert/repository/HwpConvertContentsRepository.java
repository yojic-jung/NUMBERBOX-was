...
public interface HwpConvertContentsRepository extends JpaRepository<HwpConvertContents, Long> {
	...
	public int changeErrStts(@Param("uuid") UUID uuid, @Param("convertNo") long convertNo,
			@Param("errStts") boolean errStts);
	...
	public int changeConverted(@Param("uuid") UUID uuid, @Param("convertNo") long convertNo,
