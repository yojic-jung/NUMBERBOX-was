...
public class FormulKey {
    ...
    @Builder
    public FormulKey(int id, int formulOrder, String formulName, String formulUi, String shortcutKey,
                     String latexGrammer, String nbGrammer, String guide, String shortcutKeycode, String texGrammer,
                     int lineChange, String classification) {
        this.id = id;
