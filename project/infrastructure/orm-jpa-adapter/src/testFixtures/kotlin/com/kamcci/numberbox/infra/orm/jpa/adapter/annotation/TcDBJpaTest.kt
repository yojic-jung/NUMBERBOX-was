...
import com.kamcci.numberbox.infra.orm.jpa.adapter.config.*
...
@Import(value = [QueryDslConfiguration::class, MockOrmBeanConfig::class, TCDataSourceConfig::class, TestRedisConfig::class])
