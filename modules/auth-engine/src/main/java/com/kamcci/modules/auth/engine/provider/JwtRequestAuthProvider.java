...
public class JwtRequestAuthProvider implements AuthenticationProvider {
    ...
    public JwtRequestAuthProvider(JwtRequestUserDetailServiceWrapper userTokenDetailService,
    ...
    public Authentication authenticate(Authentication authentication) {
        ...
        final AuthUserDetail user = (AuthUserDetail) userTokenDetailService.loadUserByUsername(email);
