package com.kamcci.modules.hwp.client.control.client
...
interface HwpSocketClient {
    ...
    //  hwp 파일을 html로 변환 요청 (문자, 수식문법, 이미지가 포함된 html)
    fun requestHtmlZip(hwpFileIS: InputStream, extension: HwpExtensionType): ByteArray
}