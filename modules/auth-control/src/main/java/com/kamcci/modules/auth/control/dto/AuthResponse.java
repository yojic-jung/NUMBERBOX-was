...
public enum AuthResponse {
    ...
    BAD_AUTH_REQUEST(400, "잘못된 형식의 요청입니다."),  // 잘못된 형식 요청

    USER_NOT_FOUND(403, "이메일과 비밀번호를 다시 한번 입력해주시기 바랍니다."),    // 계정 미존재

    AUTH_SERVER_ERROR(500, "로그인 인증 과정 중 서버 예외 발생"), // 서버 예외

    ABLE_USER(403, "계정 잠금이 풀렸습니다.\n다시 로그인 시도해주세요."),   // 계정 잠금 풀림

    DISABLE_USER(403, "해당 계정이 잠금되었습니다.\n15분 후 다시 시도해주세요."),  // 계정 잠금

    PASSWORD_MISS_MATCH(403, "이메일과 비밀번호를 다시 한번 입력해주시기 바랍니다.\n5회 이상 실패시 15분간 계정이 비활성화 됩니다."), // 비밀번호 불이리
