...
public interface MathConLikeInfoRepository extends JpaRepository <MathConLikeInfo, Integer> {
	...
	public MathConLikeInfo findByMathConLikeDomainContentsNoAndMathConLikeDomainUserUniqId(int contentsNo, UUID userUniqId);
	
	public List<MathConLikeInfo> findByMathConLikeDomainContentsNoInAndMathConLikeDomainUserUniqId(List<Integer> contentsNo, UUID userUniqId);
