...
public class AwsS3Service {
	    ...
	    public String uploadToS3SeverSingleFile(int actionId, MultipartFile file) throws IOException {
	    	...
	    	if(actionId==10) {
	    		fileName = "editorImgUpld/"+actionId+""+year+""+monthValue+"/"+currentTime1+"_"+randomValue1+"_"+file.getOriginalFilename();
	    	}else if(actionId==11) {
	    		fileName = "hwpToHtml/"+actionId+""+year+""+monthValue+"/"+currentTime1+"_"+randomValue1+"_"+file.getOriginalFilename();
	    	}
	    ...
	    public String uploadToS3SeverSingleFile(int actionId, File file, String fileName) throws IOException {
	      ...
	      //폴더 이름 생성 규칙은 actionId-연월
	    	if(actionId==10) {
	    		if(fileName == null) {
	    			fileName = "editorImgUpld/"+actionId+""+year+""+monthValue+"/"+currentTime1+"_"+randomValue1+"_"+file.getName();
		        }else {
	    		...
	    		if(fileName == null) {
	    			fileName = "hwpToHtml/"+actionId+""+year+""+monthValue+"/"+currentTime1+"_"+randomValue1+"_"+file.getName();
	    		}else {
