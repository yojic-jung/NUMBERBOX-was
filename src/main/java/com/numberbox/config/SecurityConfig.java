...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .requestMatchers(CorsUtils::isPreFlightRequest).permitAll()		//cors 추가
                ...
                .antMatchers(HttpMethod.GET, "/delRefreshToken").hasAnyRole("USER")
                ...
                .antMatchers(HttpMethod.POST, "/mathInfo/registerIpsiContents").hasAnyRole("ADMIN")
                ...
                .antMatchers(HttpMethod.GET, "/mathDocs/mathDocsIpsi").hasAnyRole("USER")
