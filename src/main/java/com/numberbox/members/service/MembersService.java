...
public class MembersService {
	...
	@Transactional
	public HashMap<String, Object> registerProfileImg(MembersProfileDto membersProfileDto, String path)
	...
	public HashMap<String, Object> findPassword(HttpServletRequest request, String email)
	...
	public HashMap<String, Object> changePassword(PasswordModel passwordModel) {
		...
		Members members = StaticSecurityUtil.getMembers();
		Members corfirmMembers = membersRepository.findByEmail(members.getEmail());
		boolean isCertified = bCryptPasswordEncoder.matches(passwordModel.getOldPassword(),
