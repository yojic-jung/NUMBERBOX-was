...
public class MembersController {
	...
	public HashMap<String, Object> takeUserProfile(@RequestParam int userNo, HttpServletRequest request,
			HttpServletResponse response) {
	...
	public HashMap<String, Object> registerProfileImg(@ModelAttribute MembersProfileDto membersProfileDto,
	...
	public HashMap<String, Object> changeNickname(@RequestParam String nickname, HttpServletRequest request,
	...
	public HashMap<String, Object> followingCancel(@RequestParam int userNo, HttpServletRequest request,
			HttpServletResponse response) throws IllegalStateException, IOException {
	...
	public void takeHwpFile(HwpJsonStrDto hwpJsonDto, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
